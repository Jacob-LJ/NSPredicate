...
- (void)viewDidLoad {
    ...
    NSLog(@"match2_keyPath_predicate--%@",(match2)? @"YES":@"NO");
    ...
    NSLog(@"通过键值编码提取对应键的值--%@",names);
    NSLog(@"通过键值编码提取对应键的值--%@",engineNames);
